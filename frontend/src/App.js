              ...
              <div className="space-y-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex justify-center gap-4 pt-12">
                  <button
                    ...
                    className="px-10 py-4 bg-blue-600 text-white rounded-md hover:bg-blue-700 transition-all duration-200 font-semibold shadow-sm hover:shadow-md text-base flex items-center gap-2"
                  >
