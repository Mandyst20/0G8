...
// Custom Before/After Slider Component with smooth dragging
function BeforeAfterSlider({ beforeImage, afterImage, beforeLabel, afterLabel }) {
  ...
  // Click anywhere on the image to move slider there
  ...
  return (
    ...
    >
      ...
      >
        {/* Slider Handle */}
        <div
          className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-12 h-12 bg-white rounded-full shadow-xl border-4 border-blue-500 cursor-grab active:cursor-grabbing flex items-center justify-center hover:scale-110 transition-transform"
              ...
              <div className="space-y-8 pt-8 border-t border-gray-200">
                ...
                <div className="flex justify-center gap-4 pt-12">
                  <button
                    ...
                    className={`px-10 py-4 ${isGeneratingPDF ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'} text-white rounded-md transition-all duration-200 font-semibold shadow-sm hover:shadow-md text-base flex items-center gap-2 ${isGeneratingPDF ? 'cursor-wait' : 'cursor-pointer'}`}
                  >
                    {isGeneratingPDF ? (
                      <>
